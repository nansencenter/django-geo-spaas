    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_constraints', models.CharField(blank=True, choices=[('accessLevel0', 'Limited'), ('accessLevel1', 'In-house'), ('accessLevel2', 'Public')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uri', models.URLField(validators=[django.core.validators.URLValidator(schemes=['http', 'https', 'ftp', 'ftps', 'file'])])),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.Dataset')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('Investigator', 'Investigator'), ('Technical Contact', 'Technical Contact'), ('DIF Author', 'DIF Author')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specs', models.CharField(default='', help_text='Further specifications of the source.', max_length=50)),
