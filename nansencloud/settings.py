...
STATIC_ROOT = os.path.join("/Webdata/maires.nersc.no/public_html", "site_media", "static")
# uploaded media will be put here:
MEDIA_ROOT = os.path.join("/Webdata/maires.nersc.no/public_html", "site_media", "media")
...
STATICFILES_DIRS = (
    ...
    '/WebData/maires.nersc.no/public_html/site_media/static',
)
...
SECRET_KEY = 'fvw@mc0j(fj6=)@kk2ov!z6pmilmznd8nd4dbx)5j3@$k8#fo-'
...
from nansencloud.databases_postgis import DATABASES
